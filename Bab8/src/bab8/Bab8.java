...
//               int jumlahKursi = Integer.parseInt(JOptionPane.showInputDialog(null, "Jumlahmurid masing - masing kelas : ","Input",
...
//            arr[2] = 7;
//            arr[3] = 1;
//            while (hasil == true) {String input = JOptionPane.showInputDialog(null,"masukan bilangan bulat :");
//            int cekInputan = Integer.parseInt(input);
//            for (int a = 0; a < 4; a++) {if (cekInputan == arr[a]){
//            hasil = false;
//            break;
//            } else {
//            hasil = true;
